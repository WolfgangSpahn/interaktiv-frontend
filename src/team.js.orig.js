import { doFetch, getIPSocket,BASE_URL } from './services.js';
...
export async function createTeam(){
    ...
    let height = 95;
    let iconCount = 0;
    // // check whether the uuid is already set, otherwise create a new one
    ...
    // let name = null;
    // // fetch the nickname from the server
    ...
    //     console.log(`Nickname ${name} set in localStorage`);
    // } else {
    ...
    while (icon) {
        console.log(`icon ${icon.name} path: ${icon.path}`);
